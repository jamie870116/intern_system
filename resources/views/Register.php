				...
				<div role="tabpanel" class="tab">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active" id="student">
							<div class="col">      
								<p>身份別</p>
								<select name="u_status" id='Su_status' class="data">
									<option value="0">老師</option>
									<option value="1">學生</option>
								</select>
							</div>
							<div class="col" data-toggle="tooltip" data-placement="right" title="請輸入學號或學校信箱">
								<input type="text" required name="account" id='Saccount' class="data" >
								<span class="highlight"></span>
								<span class="bar"></span>
								<label>帳號</label>
							</div>
							<div class="col" data-toggle="tooltip" data-placement="right" title="請輸入6~20字元" style="font-size: 16px">
								<input type="password" required name="password" id='Spassword' class="data">
								<span class="highlight"></span>
								<span class="bar"></span>
								<label>密碼</label>
							</div>
							<div class="col">      
								<input type="password" required name="conf_pass" id='Sconf_pass' class="data">
								<span class="highlight"></span>
								<span class="bar"></span>
								<label>確認密碼</label>
							</div>
							<div class="col">      
								<input type="text" required name="u_name" id='Su_name' class="data">
								<span class="highlight"></span>
								<span class="bar"></span>
								<label>姓名</label>
							</div>
							<div class="col">      
								<input type="text" required name="u_tel" id='Su_tel' class="data">
								<span class="highlight"></span>
								<span class="bar"></span>
								<label>電話</label>
							</div>
							<div class="col">
								...
								<a href="http://his.nutc.edu.tw/s1110234015/intern_system/public/"><button type="submit">去登入</button></a>
							</div>
						</div>
						<div role="tabpanel" class="tab-pane" id="enterprise">
							<div class="col">      
								<input type="text" required name="account" id='Eaccount' class="data" >
								<span class="highlight"></span>
								<span class="bar"></span>
								<label>帳號</label>
							</div>
							<div class="col">      
								<input type="password" required name="password" id='Epassword' class="data">
								<span class="highlight"></span>
								<span class="bar"></span>
								<label>密碼</label>
							</div>
							<div class="col">      
								<input type="password" required name="conf_pass" id='Econf_pass' class="data">
								<span class="highlight"></span>
								<span class="bar"></span>
								<label>確認密碼</label>
							</div>
							<div class="col">      
								<input type="text" required name="u_name" id='Eu_name' class="data">
								<span class="highlight"></span>
								<span class="bar"></span>
								<label>公司名稱</label>
							</div>
							<div class="col">      
								<input type="text" required name="u_tel" id='Eu_tel' class="u_tel data">
								<span class="highlight"></span>
								<span class="bar"></span>
								<label>公司電話</label>
							</div>
							<div class="col">      
								<input type="text" required name="email" id='Eemail' class="data">
								<span class="highlight"></span>
								<span class="bar"></span>
								<label>E-Mail</label>
							</div>
